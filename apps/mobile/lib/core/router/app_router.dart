...
/// Application-wide [GoRouter] provider. Re-evaluates redirects whenever
/// the [PlayGridController] notifies (sign in / sign out / profile saved).
final Provider<GoRouter> appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      final bool isSetupRoute = location == RoutePaths.profileSetup;
