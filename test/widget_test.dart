...
void main() {
  testWidgets('shows the login surface when no Supabase credentials are set', (tester) async {
  ...
  test('local repository rejects overlapping bookings', () async {
    ...
    final state = await repository.bootstrap(session: PlayGridMockData.memberSession);
